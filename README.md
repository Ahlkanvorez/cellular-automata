...
* [`src/cljs/cells/`](src/cljs/cells/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/cells/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `cells` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/cells/config.cljs) defaults to `true` in
...
```clj
(ns cells.example
  (:require [cells.config :as config])
